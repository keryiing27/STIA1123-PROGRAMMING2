...
public class WedAdminAds extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WedAdminAds frame = new WedAdminAds();
	...
	public WedAdminAds() {
		...
		lblNewLabel_2.setIcon(new ImageIcon("D:\\eclipse_latest\\P2asst\\src\\Project\\image\\image3.jpg"));
		lblNewLabel_2.setBounds(-64, 0, 231, 168);
		panel_2.add(lblNewLabel_2);
		
		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setIcon(new ImageIcon("D:\\eclipse_latest\\P2asst\\src\\Project\\image\\image5.jpg"));
		lblNewLabel_6.setBounds(168, 0, 154, 168);
		panel_2.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("");
		lblNewLabel_7.setIcon(new ImageIcon("D:\\eclipse_latest\\P2asst\\src\\Project\\image\\image6.jpg"));
		lblNewLabel_7.setBounds(305, 0, 165, 198);
		panel_2.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("");
		lblNewLabel_8.setIcon(new ImageIcon("D:\\eclipse_latest\\P2asst\\src\\Project\\image\\image7.jpg"));
		lblNewLabel_8.setBounds(431, 0, 134, 168);
