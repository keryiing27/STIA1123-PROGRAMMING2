...
public class WedAdminPack extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WedAdminPack frame = new WedAdminPack();
	...
	public WedAdminPack() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					File file = new File("D:\\eclipse_latest\\P2asst\\src\\Project\\AdminWedPackage.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
		...
		Background.setIcon(new ImageIcon("D:\\eclipse_latest\\P2asst\\src\\Project\\image\\pexels-photo-2788494.jpeg"));
