...
public class AdminComBackground extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminComBackground frame = new AdminComBackground();
	...
	public AdminComBackground() {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					File file = new File("D:\\eclipse_latest\\P2asst\\src\\Asst3GUI\\AdminComBackground.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
	...
	public void setTable(JTable table) {
		AdminComBackground.table = table;
	}
